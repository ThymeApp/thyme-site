    ...
    <div className="Home Bigger">
        ...
        <Grid container stackable columns={3} verticalAlign='top'>
          <Grid.Row>
            ...
            <Grid.Column style={{ padding: '0 3rem' }}>
              ...
              <p>
                Thyme values your privacy. Every feature is developed with a
            ...
            <Grid.Column style={{ padding: '0 3rem' }}>
              ...
              <p>
                Create and export reports of your timesheets for your archive
                and get insights in the hours you spent during the week.
              </p>
              <p>
      ...
      <Segment style={{ padding: '8em 0em' }} vertical>
        <Container text>
          ...
          <p>
            You don't need other people (and companies) looking over your
            shoulder when keeping your time. With Thyme you control and keep
            your own data right in your browser.
          </p>
        </Container>
        ...
        <Grid container stackable verticalAlign='middle'>
          <Grid.Row>
            <Grid.Column width={6}>
              ...
              <p>
                This includes a more detailed version with your notes and more.
                Also, reports can be easily exported to PDF or printed.
              </p>
            </Grid.Column>
